...
@spec  crc_itu(data: String) :: String
  ...
  defp process_crc_data(data, crc, len, data_len) when len < data_len do
    crc =
      bxor(
        crc >>> 8,
        Enum.at(
          @ref_table,
          bxor(crc, String.to_integer(String.slice(data, len..(len + 1)), 16)) &&& 0xFF
        )
      )
  ...
  defp process_crc_data(_, crc, _, _), do: crc
  ...
  defp fill_even_zero(str) do
    (String.length(str) |> rem(2) == 0 && str) || "0" <> str
  end
end
